...
class Upload {
    ...
    private $config =   array(
        ...
        'imageClassPath'    =>  '@.Tools.Image',    // 图库类包路径
    ...
    private function save($file) {
        ...
        if($this->thumb && in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png'))) {
            ...
            if(false !== $image) {
                ...
                $imageCutter = new Image(1, $filename);
                ...
                for($i=0,$len=count($thumbWidth); $i<$len; $i++) {
                    ...
                    $imageCutter->thumb($filename,$thumbPath.$thumbname.'.'.$thumbExt,'',$thumbWidth[$i],$thumbHeight[$i],true);
                }
