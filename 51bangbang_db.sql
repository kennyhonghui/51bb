...
CREATE TABLE IF NOT EXISTS `bb_51_catedata` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `catid` int(10) unsigned NOT NULL COMMENT '关联分类ID',
  `data` varchar(100) NOT NULL COMMENT '自定义数据',
  PRIMARY KEY (`id`),
  KEY `catid` (`catid`)
...
CREATE TABLE IF NOT EXISTS `bb_51_feedback` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`,`status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='意见反馈表格' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `bb_51_feedback`
--

INSERT INTO `bb_51_feedback` (`id`, `uid`, `content`, `create_time`, `status`, `reply`) VALUES
(1, 2, '我要吃肯德基', 1437803159, 0, '');
...
CREATE TABLE IF NOT EXISTS `bb_51_image` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文件ID',
  `uid` int(11) unsigned NOT NULL COMMENT '关联用户ID',
...
INSERT INTO `bb_51_image` (`id`, `uid`, `name`, `savename`, `savepath`, `ext`, `mime`, `size`, `md5`, `sha1`, `url`, `create_time`) VALUES
(1, 1, 'about_pay_icon.png', '20150725161828_1.png', './Uploads/51bangbang/userphoto', 'png', 'image/png', 33595, '', 'bd41b031f120a7c6dd216363a5f3ee6d', './Uploads/51bangbang/userphotos/20150725161828_1.png', 1437812308);
...
CREATE TABLE IF NOT EXISTS `bb_51_orders` (
  `uid` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户ID',
  `orderid` int(10) unsigned NOT NULL COMMENT '订单ID',
  `status` tinyint(4) unsigned NOT NULL COMMENT '订单状态',
  `undertaker` int(10) unsigned NOT NULL COMMENT '接单人用户ID',
  `calegoryid` smallint(10) unsigned NOT NULL COMMENT '行业分类ID',
  `order_fee` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单总额',
  `deposit` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '已付订金',
  `content` varchar(255) NOT NULL COMMENT '订单需求内容',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `is_deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  UNIQUE KEY `orderid` (`orderid`),
  KEY `uid` (`uid`),
  KEY `calegoryid` (`calegoryid`)
...
CREATE TABLE IF NOT EXISTS `bb_51_smscode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mobile` varchar(11) NOT NULL,
  `count` int(11) NOT NULL,
  `datetime` datetime NOT NULL,
  `code` varchar(100) NOT NULL,
  `todo` varchar(10) NOT NULL COMMENT '获取验证码的用途',
...
CREATE TABLE IF NOT EXISTS `bb_51_user` (
  `uid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户ID',
  `userphoto` varchar(100) NOT NULL COMMENT '用户头像',
  ...
  `login_status` int(2) unsigned NOT NULL DEFAULT '0' COMMENT '在线状态',
  PRIMARY KEY (`uid`),
  UNIQUE KEY `mobile` (`mobile`),
  KEY `status` (`status`)
...
CREATE TABLE IF NOT EXISTS `bb_51_userdata` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `uid` int(10) unsigned NOT NULL COMMENT '关联用户ID',
  `userkey` varchar(50) NOT NULL COMMENT '用户密匙',
  PRIMARY KEY (`id`),
  UNIQUE KEY `userkey` (`userkey`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `bb_51_userdata`
--
...
CREATE TABLE IF NOT EXISTS `bb_action` (
...
INSERT INTO `bb_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `bb_action_log` (
...
INSERT INTO `bb_action_log` (`id`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
(1, 1, 1, 2130706433, 'member', 1, 'admin在2015-07-21 15:59登录了后台', 1, 1437465560),
(2, 11, 1, 2130706433, 'category', 1, '操作url：/51bb/admin.php?s=/Category/edit.html', 1, 1437466405),
(3, 11, 1, 2130706433, 'category', 2, '操作url：/51bb/admin.php?s=/Category/edit.html', 1, 1437466418),
(4, 11, 1, 2130706433, 'category', 39, '操作url：/51bb/admin.php?s=/Category/add.html', 1, 1437466621),
(5, 11, 1, 2130706433, 'category', 40, '操作url：/51bb/admin.php?s=/Category/add.html', 1, 1437466752),
(6, 11, 1, 2130706433, 'category', 41, '操作url：/51bb/admin.php?s=/Category/add.html', 1, 1437466780),
(7, 11, 1, 2130706433, 'category', 42, '操作url：/51bb/admin.php?s=/Category/add.html', 1, 1437466802),
(8, 11, 1, 2130706433, 'category', 43, '操作url：/51bb/admin.php?s=/Category/add.html', 1, 1437466838),
(9, 1, 1, 2130706433, 'member', 1, 'admin在2015-07-23 20:13登录了后台', 1, 1437653581),
(10, 11, 1, 2130706433, 'category', 44, '操作url：/51bb/admin.php?s=/Category/add.html', 1, 1437653681),
(11, 11, 1, 2130706433, 'category', 2, '操作url：/51bb/admin.php?s=/Category/edit.html', 1, 1437653719),
(12, 1, 1, 2130706433, 'member', 1, 'admin在2015-07-25 14:54登录了后台', 1, 1437807255),
(13, 11, 1, 2130706433, 'category', 44, '操作url：/51bb/admin.php?s=/Category/remove/id/44.html', 1, 1437807373),
(14, 11, 1, 2130706433, 'category', 39, '操作url：/51bb/admin.php?s=/Category/edit.html', 1, 1437808443),
...
CREATE TABLE IF NOT EXISTS `bb_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `bb_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
CREATE TABLE IF NOT EXISTS `bb_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `bb_attribute`
--

INSERT INTO `bb_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
CREATE TABLE IF NOT EXISTS `bb_auth_extend` (
...
--
-- 转存表中的数据 `bb_auth_extend`
--

INSERT INTO `bb_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
CREATE TABLE IF NOT EXISTS `bb_auth_group` (
...
--
-- 转存表中的数据 `bb_auth_group`
--

INSERT INTO `bb_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
...
--
-- 表的结构 `bb_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `bb_auth_group_access` (
...
CREATE TABLE IF NOT EXISTS `bb_auth_rule` (
...
--
-- 转存表中的数据 `bb_auth_rule`
--

INSERT INTO `bb_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `bb_category` (
...
INSERT INTO `bb_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`) VALUES
...
CREATE TABLE IF NOT EXISTS `bb_document` (
...
--
-- 表的结构 `bb_document_article`
--

CREATE TABLE IF NOT EXISTS `bb_document_article` (
...
--
-- 表的结构 `bb_document_download`
--

CREATE TABLE IF NOT EXISTS `bb_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
CREATE TABLE IF NOT EXISTS `bb_file` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文件ID',
  `name` char(30) NOT NULL DEFAULT '' COMMENT '原始文件名',
  `savename` char(20) NOT NULL DEFAULT '' COMMENT '保存名称',
  `savepath` char(30) NOT NULL DEFAULT '' COMMENT '文件保存路径',
...
INSERT INTO `bb_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`, `status`) VALUES
...
INSERT INTO `bb_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `bb_model` (
...
INSERT INTO `bb_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `attribute_alias`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
CREATE TABLE IF NOT EXISTS `bb_picture` (
...
--
-- 表的结构 `bb_ucenter_admin`
--

CREATE TABLE IF NOT EXISTS `bb_ucenter_admin` (
...
CREATE TABLE IF NOT EXISTS `bb_ucenter_app` (
...
--
-- 表的结构 `bb_ucenter_member`
--

CREATE TABLE IF NOT EXISTS `bb_ucenter_member` (
...
--
-- 表的结构 `bb_ucenter_setting`
--

CREATE TABLE IF NOT EXISTS `bb_ucenter_setting` (
...
CREATE TABLE IF NOT EXISTS `bb_url` (
...
CREATE TABLE IF NOT EXISTS `bb_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
